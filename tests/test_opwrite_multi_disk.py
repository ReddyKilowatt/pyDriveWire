...
def test_opwrite_multi_disk():
    ...
    # TODO Read & write multiple disk numbers from the same program
    # this program should start the server, and load the appropriate disk
    # into the correct slots, that are expected by this program
    # This means launching the server from this program (or a batch file)
    # before calling socket_init()
