...
"""
renamed from dwdisktester.py, so that the test runner would see this as a unittest
"""


"""
Adding command line arguments to test files
    ...
    if True:
        ...
        for fileName in sys.argv[1:]:
            ...
            while rc == E_OK:
                ...
                # Mike sent me this print via Discord, after sending me the test file
